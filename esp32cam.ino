...
String BOTtoken = "6062856074:AAFfBmnC_LlwqJRnw-DSgWseNiYHlkROSaU";  // your Bot Token (Get from Botfather)
String CHAT_ID = "6088994423";
...
void setup() {
  ...
  bot.sendMessage(CHAT_ID, "Device Online !", "");
}
